                        ...
                        <div class="wrapper-content pd-all-20">
                            ...
                            <div data-type="s3" class="setting-wrapper @if(setting('media_driver', config('filesystems.default')) != 's3') hidden @endif">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="next-input" name="media_aws_bucket" id="media_aws_bucket"
                                           value="{{ config('filesystems.disks.s3.bucket') }}" placeholder="Ex: app">
                                </div>
                                <div class="form-group" style="margin-bottom: 1rem;">
                                    ...
                                    <input type="text" class="next-input" name="media_aws_url" id="media_aws_url"
                                           value="{{ config('filesystems.disks.s3.url') }}" placeholder="Ex: https://s3-ap-southeast-1.amazonaws.com/app">
                                </div>
                            </div>
                            ...
                            <div data-type="do_spaces" class="setting-wrapper @if (setting('media_driver', config('filesystems.default')) !== 'do_spaces') hidden @endif">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="next-input" name="media_do_spaces_bucket" id="media_do_spaces_bucket"
                                           value="{{ config('filesystems.disks.do_spaces.bucket') }}" placeholder="Ex: keyword">
                                </div>
                                <div class="form-group" style="margin-bottom: 1rem;">
                                    <label class="text-title-field"
                            ...
                            <div class="form-group">
                                ...
                                <label class="hrv-label">
                                    <input type="radio" name="media_chunk_enabled" class="hrv-radio"
                                           value="1"
                                           @if (setting('media_chunk_enabled', config('core.media.chunk.enabled'))) checked @endif>{{ trans('core/setting::setting.general.yes') }}
                                </label>
                                <label class="hrv-label">
                                    <input type="radio" name="media_chunk_enabled" class="hrv-radio"
                                           value="0"
                                           @if (!setting('media_chunk_enabled', config('core.media.chunk.enabled'))) checked @endif>{{ trans('core/setting::setting.general.no') }}
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="next-input" name="media_chunk_size" id="media_chunk_size"
                                       value="{{ setting('media_chunk_size', config('core.media.chunk.chunk_size')) }}" placeholder="{{ trans('core/setting::setting.media.chunk_size_placeholder') }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="next-input" name="media_max_file_size" id="media_max_file_size"
                                       value="{{ setting('media_max_file_size', config('core.media.chunk.max_file_size')) }}" placeholder="{{ trans('core/setting::setting.media.max_file_size_placeholder') }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="hrv-label">
                                    <input type="radio" name="media_watermark_enabled" class="hrv-radio"
                                           value="1"
                                           @if (setting('media_watermark_enabled', config('core.media.watermark.enabled'))) checked @endif>{{ trans('core/setting::setting.general.yes') }}
                                </label>
                                <label class="hrv-label">
                                    <input type="radio" name="media_watermark_enabled" class="hrv-radio"
                                           value="0"
                                           @if (!setting('media_watermark_enabled', config('core.media.watermark.enabled'))) checked @endif>{{ trans('core/setting::setting.general.no') }}
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="next-input" name="media_watermark_size" id="media_watermark_size"
                                       value="{{ setting('media_watermark_size', config('core.media.watermark.size')) }}" placeholder="{{ trans('core/setting::setting.media.watermark_size_placeholder') }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="next-input" name="watermark_opacity" id="watermark_opacity"
                                       value="{{ setting('watermark_opacity', config('core.media.watermark.opacity')) }}" placeholder="{{ trans('core/setting::setting.media.watermark_opacity_placeholder') }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="ui-select-wrapper">
                                    <select name="media_watermark_position" class="ui-select" id="media_watermark_position">
                                        <option value="top-left" @if (setting('media_watermark_position', config('core.media.watermark.position')) == 'top-left' ) selected @endif>{{ trans('core/setting::setting.media.watermark_position_top_left') }}</option>
                                        <option value="top-right" @if (setting('media_watermark_position', config('core.media.watermark.position')) == 'top-right' ) selected @endif>{{ trans('core/setting::setting.media.watermark_position_top_right') }}</option>
                                        <option value="bottom-left" @if (setting('media_watermark_position', config('core.media.watermark.position')) == 'bottom-left' ) selected @endif>{{ trans('core/setting::setting.media.watermark_position_bottom_left') }}</option>
                                        <option value="bottom-right" @if (setting('media_watermark_position', config('core.media.watermark.position')) == 'bottom-right' ) selected @endif>{{ trans('core/setting::setting.media.watermark_position_bottom_right') }}</option>
                                        <option value="center" @if (setting('media_watermark_position', config('core.media.watermark.position')) == 'center' ) selected @endif>{{ trans('core/setting::setting.media.watermark_position_center') }}</option>
                                    </select>
                                    <svg class="svg-next-icon svg-next-icon-size-16">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#select-chevron"></use>
                                    </svg>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="next-input" name="watermark_position_x" id="watermark_position_x"
                                       value="{{ setting('watermark_position_x', config('core.media.watermark.x')) }}" placeholder="{{ trans('core/setting::setting.media.watermark_position_x') }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="next-input" name="watermark_position_y" id="watermark_position_y"
                                       value="{{ setting('watermark_position_y', config('core.media.watermark.y')) }}" placeholder="{{ trans('core/setting::setting.media.watermark_position_y') }}">
                            </div>

                        </div>
                    </div><!-- ./flexbox-annotated-section-content -->

                </div><!-- ./flexbox-annotated-section -->
