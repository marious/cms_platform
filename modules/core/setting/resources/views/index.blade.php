            ...
            <div class="max-width-1200">
                <div class="flexbox-annotated-section">
                    ...
                    <div class="flexbox-annotated-section-content">
                        <div class="wrapper-content pd-all-20">
                            ...
                            <div class="form-group">
                                <label class="text-title-field" for="time_zone">{{ trans('core/setting::setting.general.time_zone') }}</label>
                            ...
                            <div class="form-group">
                                <label for="text-title-field" for="locale">{{ trans('core/setting::setting.general.locale') }}</label>
                                <div class="ui-select-wrapper">
                                    <select name="locale" class="ui-select form-control select-search-full" id="locale">
                                        @foreach (\EG\Base\Supports\Language::getAvailableLocales() as $key => $locale)
                            ...
                            <div class="form-group">
                                <label class="text-title-field" for="locale_direction">{{ trans('core/setting::setting.general.locale_direction') }}</label>
                                <label class="hrv-label">
                                    <input type="radio" name="locale_direction" class="hrv-radio" value="ltr"
                                    @if(setting('locale_direction', 'ltr') == 'ltr') checked @endif> {{ trans('core/setting::setting.general.left_to_right') }}
                                </label>

                                <label class="hrv-label">
                                    <input type="radio" name="locale_direction" class="hrv-radio" value="rtl"
                                           @if(setting('locale_direction', 'rtl') == 'rtl') checked @endif> {{ trans('core/setting::setting.general.right_to_left') }}
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <label>
                                    <input type="checkbox" class="hrv-checkbox" value="1"
                                        @if(setting('enable_send_error_reporting_via_email')) checked @endif name="enable_send_error_reporting_via_email">
                ...
                <div class="flexbox-annotated-section">
                    ...
                    <div class="flexbox-annotated-section-content">
                        <div class="wrapper-content pd-all-20">
                            <div class="form-group">
                                <label for="text-title-field" class="admin_logo">
                            ...
                            @if (count(Assets2::getAdminLocales()) > 1)
                                <div class="form-group">
