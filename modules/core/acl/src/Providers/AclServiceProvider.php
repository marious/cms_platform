...
use EG\ACL\Http\Middleware\Authenticate;
use EG\ACL\Repositories\Eloquent\RoleRepository;
use EG\ACL\Repositories\Eloquent\UserRepository;
use EG\ACL\Repositories\Interfaces\RoleInterface;
use EG\ACL\Repositories\Interfaces\UserInterface;
use EG\ACL\Repositories\Caches\RoleCacheDecorator;
use EG\ACL\Http\Middleware\RedirectIfAuthenticated;
use EG\ACL\Repositories\Eloquent\ActivationRepository;
