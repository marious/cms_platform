...
use EG\Base\Forms\Fields\AutoCompleteField;
use EG\Base\Forms\Fields\ColorField;
use EG\Base\Forms\Fields\CustomRadioField;
use EG\Base\Forms\Fields\CustomSelectField;
use EG\Base\Forms\Fields\EditorField;
use EG\Base\Forms\Fields\HtmlField;
use EG\Base\Forms\Fields\MediaFileField;
use EG\Base\Forms\Fields\MediaImageField;
use EG\Base\Forms\Fields\MediaImagesField;
use EG\Base\Forms\Fields\OnOffField;
use EG\Base\Forms\Fields\TimeField;
...
abstract class FormAbstract extends Form
{
    ...
    public function hasMultiLangTabs()
    {
        if (count(Language::getSupportedLocales()) > 1) {
            $this->setFormOption('template', 'core/base::forms.form-tabs-multi-lang');
        }
        return $this;
    }
    ...
    {
        Assets2::addScripts(['form-validation', 'are-you-sure']);
