...
abstract class TableAbstract extends DataTable
{
        ...
        return $this->builder()
            ...
            ->parameters([
                ...
                'language'     => [
                    ...
                    'processing'        => Html::image(url('vendor/core/base/images/loading-spinner-blue.gif')),
                    'paginate'          => [
                        'next'     => trans('pagination.next'),
                        'previous' => trans('pagination.previous'),
                    ],
    ...
    {
        Assets2::addScripts(['datatables', 'moment', 'datepicker'])
