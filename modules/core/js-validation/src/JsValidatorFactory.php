...
namespace EG\JsValidation;

use Illuminate\Contracts\Validation\Factory as ValidationFactory;
use Illuminate\Support\Arr;
use Illuminate\Validation\Validator;
use EG\JsValidation\Javascript\JavascriptValidator;
use EG\JsValidation\Javascript\MessageParser;
use EG\JsValidation\Javascript\RuleParser;
use EG\JsValidation\Javascript\ValidatorHandler;
use EG\JsValidation\Support\DelegatedValidator;
use EG\JsValidation\Support\ValidationRuleParserProxy;
...
class JsValidatorFactory
{
     ...
     * @return \EG\JsValidation\Javascript\JavascriptValidator
     */
