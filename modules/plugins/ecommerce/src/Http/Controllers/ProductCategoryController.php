...
use EG\Ecommerce\Forms\ProductCategoryForm;
use EG\Ecommerce\Http\Requests\ProductCategoryRequest;
use EG\Ecommerce\Repositories\Interfaces\ProductCategoryInterface;
use EG\Ecommerce\Tables\ProductCategoryTable;
use Exception;
...
class ProductCategoryController extends BaseController
{
    ...
    {
        return $this->executeDeleteItems($request, $response, $this->productCategoryRepository, PRODUCT_CATEGORY_MODULE_SCREEN_NAME);
