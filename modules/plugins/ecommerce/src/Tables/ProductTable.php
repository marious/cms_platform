...
namespace EG\Ecommerce\Tables;

use Auth;
use BaseHelper;
use EG\Base\Enums\BaseStatusEnum;
use EG\Ecommerce\Exports\ProductExport;
        ...
        $data = $this->table
            ...
            ->editColumn('price', function ($item) {
                if ($item->front_sale_price < $item->price) {
                    return format_price($item->front_sale_price) . ' '. '<del class="text-danger">' . format_price($item->price) . '</del>';
                }
                return format_price($item->front_sale_price);
            })
