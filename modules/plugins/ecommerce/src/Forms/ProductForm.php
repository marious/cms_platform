...
use EG\Base\Forms\Fields\MultiCheckListField;
use EG\Base\Forms\Fields\TagField;
use EG\Base\Forms\FormAbstract;
use EG\Ecommerce\Forms\Fields\CategoryMultiField;
...
class ProductForm extends FormAbstract
{
    public function buildForm()
    {
        ...
        if (EcommerceHelper::isTaxEnables()) {
