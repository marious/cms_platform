<div id="product-extras" class="widget meta-boxes">
    <div class="widget-title">
        <h4><span>{{ __('Related products') }}</span></h4>
    </div>
    <div class="widget-body">
        <div class="form-group">
            <label class="control-label">{{ __('Related products') }}</label>
        ...
        <hr>
        <div class="form-group">
            <label class="control-label">{{ __('Cross-selling products') }}</label>
        ...
        @if (false)
            <hr>
            <div class="form-group">
                <label class="control-label">{{ __('Up-selling products') }}</label>
    ...
    <tr>
        <td class="width-60-px min-width-60-px">
            <div class="wrap-img vertical-align-m-i">
                <img class="thumb-image" src="__image__" alt="__name__" title="__name__"></div>
        </td>
