                ...
                <tr>
                    ...
                    <td>
                        @if ($currentRelatedProduct)
                            {!! $currentRelatedProduct->sale_price < $currentRelatedProduct->price ? format_price($currentRelatedProduct->sale_price) . ' '. '<del class="text-danger">' . format_price($currentRelatedProduct->price) . '</del>' : format_price($currentRelatedProduct->price) !!}
                        @else
                            {{  $product->sale_price < $product->price ? format_price($product->sale_price) . ' '. '<del class="text-danger">' . format_price($product->price) . '</del>' : format_price($product->price) }}
                        @endif
                    </td>
                    <td>
                        <label>
