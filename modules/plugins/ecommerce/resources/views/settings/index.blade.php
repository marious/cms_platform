                        ...
                        <div class="form-group mb0">
                            ...
                            <div class="ui-select-wrapper">
                                <select name="store_country" class="ui-select" id="store_country">
                                    @foreach(['' => trans('plugins/ecommerce::ecommerce.setting.select_country')] + \EG\Base\Supports\Helper::countries() as $countryCode => $countryName)
                ...
                <div class="flexbox-annotated-section-content">
                    <div class="wrapper-content pd-all-20">
                        ...
                        <div class="form-group">
                            ...
                            <div class="ui-select-wrapper">
                                <select name="quick_buy_target_page" class="ui-select select-full" id="quick_buy_target_page">
