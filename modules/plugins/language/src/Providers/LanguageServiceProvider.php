...
use EG\Language\Facades\LanguageFacade;
use EG\Language\Http\Middleware\LocaleSessionRedirect;
use EG\Language\Http\Middleware\LocalizationRedirectFilter;
use EG\Language\Http\Middleware\LocalizationRoutes;
use EG\Language\Models\Language as LanguageModel;
use EG\Language\Models\LanguageMeta;
use EG\Language\Repositories\Caches\LanguageCacheDecorator;
use EG\Language\Repositories\Caches\LanguageMetaCacheDecorator;
use EG\Language\Repositories\Eloquent\LanguageMetaRepository;
use EG\Language\Repositories\Eloquent\LanguageRepository;
    ...
    public function boot()
    {
        ...
        if ($this->app->runningInConsole()) {
            ...
            Event::listen(RouteMatched::class, function () {
                ...
                Assets2::addScriptsDirectly('vendor/core/plugins/language/js/language-global.js')
