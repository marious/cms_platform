...
@section('content')
    <div class="tabbable-custom tabbable-tabdrop">
        <ul class="nav nav-tabs">
            ...
            {!! apply_filters(BASE_FILTER_REGISTER_CONTENT_TABS, null, new \EG\Language\Models\Language) !!}
        </ul>
        <div class="tab-content">
            <div class="tab-pane active" id="tab_detail">
                <div class="row">
                    <div class="col-md-5">
                        @php do_action(BASE_ACTION_META_BOXES, 'top', new \EG\Language\Models\Language) @endphp
                        <div class="main-form">
                            <div class="form-wrap">
                                <div class="form-group">
                                    ...
                                    <select id="language_id" class="form-control select-search-full">
                                        <option value="">{{ trans('plugins/language::language.select_language') }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="flag_list" class="form-control select-search-language">
                                        <option value="">{{ __('Select a flag...') }}</option>
                        ...
                        @php do_action(BASE_ACTION_META_BOXES, 'advanced', new \EG\Language\Models\Language) @endphp
                    </div>
                    <div class="col-md-7">
