...
namespace EG\Blog\Tables;

use BaseHelper;
use EG\Base\Enums\BaseStatusEnum;
use EG\Blog\Exports\PostExport;
        ...
        $data = $this->table
            ...
            ->editColumn('updated_at', function ($item) {
                ...
                foreach ($item->categories as $category) {
                    $categoryName = isset($category->name[config('app.locale').'_name']) ? $category->name[config('app.locale').'_name'] : '';
                    $categories .= Html::link(route('categories.edit', $category->id), $categoryName) . ', ';
                }
