...
use EG\Base\Supports\SortItemsWithChildrenHelper;
...
if (!function_exists('get_popular_categories')) {
     ...
     * @return array
     */
    function get_popular_categories($limit = 10, array $args = [])
    {
        return app(CategoryInterface::class)->getPopularCategories($limit, $args);
    }
}
