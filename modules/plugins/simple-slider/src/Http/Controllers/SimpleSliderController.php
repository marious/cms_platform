...
namespace EG\SimpleSlider\Http\Controllers;
...
use EG\SimpleSlider\Forms\SimpleSliderForm;
...
use Exception;
use EG\SimpleSlider\Tables\SimpleSliderTable;
...
class SimpleSliderController extends BaseController
{
    ...
    {
        Assets2::addStylesDirectly(['vendor/core/plugins/simple-slider/css/simple-slider-admin.css'])
