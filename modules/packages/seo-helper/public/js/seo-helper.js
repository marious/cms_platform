...
/***/ "./modules/packages/seo-helper/resources/assets/js/seo-helper.js":
/*!***********************************************************************!*\
  !*** ./modules/packages/seo-helper/resources/assets/js/seo-helper.js ***!
  \***********************************************************************/
...
var SEOHelperManagement = /*#__PURE__*/function () {
  ...
  _createClass(SEOHelperManagement, [{
    ...
    value: function getCurrentLang() {
      var currentTag = $('.seo-tab');
      var lang = false;
      currentTag.each(function (i, element) {
    ...
    value: function handleMetaBox() {
      ...
      var lang = this.getCurrentLang(); // if ($('#seo-tab')) {
      //     $('.page-url-seo p').each(function (i, element) {
      //         const lang = $(this).parents('.tab-pane').data('lang');
      //         console.log(element);
      //         //$(element).text(this.$document.find(`#${lang}-sample-permalink a`).prop('href').replace('?preview=true', ''));
      //     });
      // } else {
      //     $('.page-url-seo p').text(this.$document.find(`#${lang}-sample-permalink a`).prop('href').replace('?preview=true', ''));
      // }

      this.$document.on('click', '.btn-trigger-show-seo-detail', function (event) {
        event.preventDefault();

        var lang = _this.getCurrentLang();

        if (lang) {
          $(".".concat(lang, "-seo-edit-section")).toggleClass('hidden');
        } else {
...
/***/ "./modules/packages/seo-helper/resources/assets/sass/seo-helper.scss":
/*!***************************************************************************!*\
  !*** ./modules/packages/seo-helper/resources/assets/sass/seo-helper.scss ***!
  \***************************************************************************/
/*! no static exports found */
...
/***/ 0:
/*!*************************************************************************************************************************************************!*\
  !*** multi ./modules/packages/seo-helper/resources/assets/js/seo-helper.js ./modules/packages/seo-helper/resources/assets/sass/seo-helper.scss ***!
  \*************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /var/www/html/shop/modules/packages/seo-helper/resources/assets/js/seo-helper.js */"./modules/packages/seo-helper/resources/assets/js/seo-helper.js");
module.exports = __webpack_require__(/*! /var/www/html/shop/modules/packages/seo-helper/resources/assets/sass/seo-helper.scss */"./modules/packages/seo-helper/resources/assets/sass/seo-helper.scss");
