...
namespace EG\SeoHelper\Entities\Twitter;

use EG\SeoHelper\Contracts\Entities\MetaCollectionContract;
use EG\SeoHelper\Contracts\Entities\TwitterCardContract;
use EG\SeoHelper\Exceptions\InvalidTwitterCardException;
