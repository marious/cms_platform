...
class PackageRemoveCommand extends Command
{
    ...
    protected function processRemove(string $package, string $location): bool
    {
        ...
        $this->line('<info>Remove</info> <comment>"EG/' . $package . '": "*@dev"</comment> to composer.json then run <comment>composer update</comment> to remove this package!');
