...
use EG\Theme\Facades\AdminBarFacade;
use EG\Theme\Facades\ThemeOptionFacade;
...
if (!function_exists('theme_path')) {
    ...
    {
        return modules_path('themes' . DIRECTORY_SEPARATOR . $path);
    }
}

if (!function_exists('admin_bar')) {
    /**
     * @return EG\Theme\Supports\AdminBar
     */
    function admin_bar()
    {
