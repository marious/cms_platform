...
use EG\Theme\Contracts\Theme as ThemeContract;
use EG\Theme\Exceptions\UnknownLayoutFileException;
use EG\Theme\Exceptions\UnknownPartialFileException;
use EG\Theme\Exceptions\UnknownThemeException;
...
class Theme implements ThemeContract
{
    ...
    {
        $path = modules_path($this->path($theme)) . '/';
    ...
    protected function addPathLocation(string $location)
    {
        ...
        if ($this->getConfig('inherit')) {
            ...
            // Inherit theme path.
            $inheritPath = modules_path($this->path($inherit));
    ...
    public function render($statusCode = 200)
    {
        ...
        $content->withHeaders([
            'Author'            => 'mohamedraya410@gmail.com',
            'Author-Team'       => '',
            'CMS'               => 'CMS',
            'CMS-Version'       => '1.0',
        ]);
