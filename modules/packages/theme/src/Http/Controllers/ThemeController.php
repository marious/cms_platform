...
use EG\Theme\Forms\CustomCSSForm;
use EG\Theme\Http\Requests\CustomCssRequest;
use EG\Theme\Services\ThemeService;
use Exception;
use File;
...
class ThemeController extends BaseController
{
    ...
    public function index()
    {
        ...
        Assets2::addScriptsDirectly('vendor/core/packages/theme/js/theme.js');
    ...
    public function getOptions()
    {
        ...
        Assets2::addScripts(['are-you-sure', 'colorpicker'])
