...
namespace EG\Widget\Factories;

use EG\Widget\AbstractWidget;
use EG\Widget\Contracts\ApplicationWrapperContract;
use EG\Widget\Misc\InvalidWidgetClassException;
use EG\Widget\Misc\ViewExpressionTrait;
use EG\Widget\WidgetId;
use Exception;
