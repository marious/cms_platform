...
namespace Botble\Base\Facades {
    ...
    class BaseHelperFacade {
        ...
        {
            /** @var \App\Helpers\BaseHelper $instance */
            return $instance->autoload($directory);
        }
        /**
         *
         *
    ...
    class BreadcrumbsFacade {
        ...
        public static function macro($name, $macro)
        {
            \Core\Base\Supports\BreadcrumbsManager::macro($name, $macro);
        }
        /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
            \Core\Base\Supports\BreadcrumbsManager::mixin($mixin, $replace);
        }
        /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
            return \Core\Base\Supports\BreadcrumbsManager::hasMacro($name);
        }
...
namespace Botble\Ecommerce\Facades {
    ...
    class OrderHelperFacade {
         ...
         * @static
         */
        public static function getShippingDetailUrl($method)
        {
            /** @var \Botble\Ecommerce\Supports\OrderHelper $instance */
            return $instance->getShippingDetailUrl($method);
        }
        /**
         *
         *
         ...
         * @static
         */
        public static function getOrderSessionData($token)
        {
            /** @var \Botble\Ecommerce\Supports\OrderHelper $instance */
...
namespace  {
    ...
    class Assets2 extends \Core\Base\Facades\AssetsFacade {}
    class Menu extends \Botble\Menu\Facades\MenuFacade {}
    class BaseHelper extends \Core\Base\Facades\BaseHelperFacade {}
    class MetaBox extends \Core\Base\Facades\MetaBoxFacade {}
    class Action extends \Core\Base\Facades\ActionFacade {}
    class Filter extends \Core\Base\Facades\FilterFacade {}
    ...
    class JsValidator extends \Core\JsValidation\Facades\JsValidatorFacade {}
    class SeoHelper extends \Packages\SeoHelper\Facades\SeoHelperFacade {}
    class SlugHelper extends \Packages\Slug\Facades\SlugHelperFacade {}
